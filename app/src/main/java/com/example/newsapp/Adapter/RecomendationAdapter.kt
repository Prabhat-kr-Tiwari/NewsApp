...
class RecomendationAdapter  : RecyclerView.Adapter<RecomendationAdapter.ArticleViewHolder>(){
    inner class ArticleViewHolder(private val binding: RecomendationTopicItemBinding) :
