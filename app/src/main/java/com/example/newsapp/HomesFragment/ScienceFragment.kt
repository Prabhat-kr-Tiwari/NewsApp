...
import com.example.newsapp.databinding.FragmentScenceBinding
...
class ScienceFragment : Fragment() {
    lateinit var binding: FragmentScenceBinding
    ...
    override fun onCreateView(
       ...
       binding=FragmentScenceBinding.inflate(layoutInflater)
        return binding.root
    }
            ...
            when (response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        isLastPage = viewModel.scienceCategoryNewsPage == totalPages
                        if (isLastPage) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate) {
                viewModel.getNewsBasedOnScienceCategory("us")
                isScrolling = false
            }
        }
